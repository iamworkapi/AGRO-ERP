...
export const DEFAULT_VILLAGES = [
  { id: "VIL-01", name: "Kanujia Village ", block: "Sikandarpur", distanceKm: 8, registeredFarmers: 42, totalTonnageDeliveredMt: 420.5, primaryCrop: "Paddy Straw", status: "ACTIVE SOURCING" },
  { id: "VIL-02", name: "Sahjanwa ", block: "Nawabganj", distanceKm: 14, registeredFarmers: 38, totalTonnageDeliveredMt: 380.0, primaryCrop: "Paddy & Wheat Straw", status: "ACTIVE SOURCING" },
  { id: "VIL-03", name: "Bansgaon ", block: "Purwa", distanceKm: 22, registeredFarmers: 29, totalTonnageDeliveredMt: 290.4, primaryCrop: "Wheat Straw", status: "ACTIVE SOURCING" },
  { id: "VIL-04", name: "Rampur Grant ", block: "Asoha", distanceKm: 18, registeredFarmers: 31, totalTonnageDeliveredMt: 310.8, primaryCrop: "Maize Stalk", status: "ACTIVE SOURCING" },
  { id: "VIL-05", name: "Gauri Kalan ", block: "Hasanganj", distanceKm: 25, registeredFarmers: 24, totalTonnageDeliveredMt: 215.0, primaryCrop: "Paddy Straw", status: "ACTIVE SOURCING" },
  { id: "VIL-06", name: "Miyanganj ", block: "Miyanganj", distanceKm: 30, registeredFarmers: 35, totalTonnageDeliveredMt: 340.2, primaryCrop: "Multi-Crop Biomass", status: "ACTIVE SOURCING" },
  { id: "VIL-07", name: "Bichhiya ", block: "Bichhiya", distanceKm: 12, registeredFarmers: 28, totalTonnageDeliveredMt: 260.6, primaryCrop: "Paddy Straw", status: "ACTIVE SOURCING" },
  { id: "VIL-08", name: "Safipur Rural ", block: "Safipur", distanceKm: 34, registeredFarmers: 40, totalTonnageDeliveredMt: 410.0, primaryCrop: "Mustard Husk & Paddy", status: "ACTIVE SOURCING" },
];
