...
// Super Admin can create either role, unassigned. A Warehouse Admin can
// only create a Supervisor, auto-assigned to their own warehouse - both
// rules enforced server-side, this just forwards whatever the form sent.
