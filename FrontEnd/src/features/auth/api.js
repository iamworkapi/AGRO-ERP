...
export function adaptProfile(profile, warehouseId) {
  if (!profile) return null;
  return {
    id: profile.id || profile._id,
    name: profile.fullName || "Super Admin",
    fullName: profile.fullName || "Super Admin",
    role: ROLE_LABELS[profile.role] || profile.role || "Super Admin",
    ...
    warehouseId: warehouseId || profile.warehouseId,
